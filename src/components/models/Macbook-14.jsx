...
Files: ./public/models/macbook-14.glb [629.72KB] > C:\Users\Admin\OneDrive\Music\Desktop\apple\apple\macbook-14-transformed.glb [627.9KB] (0%)
...
}, [color, scene]) //it will run whenever the color changes, we also added scene to the dependency array because we are using it inside the useEffect, and we want to make sure that we are using the latest version of the scene when the color changes
//it will run whenever the color changes
